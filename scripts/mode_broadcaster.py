#!/usr/bin/python
"""
This is a pretty stupid node. It basically just takes the mode and continously broadcasts it.
I should think of a smarter way to do this
"""
...
if __name__ == '__main__':
    rospy.Subscriber('/command_mode_inst', String, position_callback)
    command_pub = rospy.Publisher('/command_mode', String, queue_size=100)
    rospy.init_node('command_mode_multiplexer', anonymous=True)
    r = rospy.Rate(10) # 10hz
    while not rospy.is_shutdown():
        
        command_pub.publish(mode)
        # rospy.spin()
        r.sleep()
