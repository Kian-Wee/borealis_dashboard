...
class Dashboard(Plugin):
    ...
    def __init__(self, context):
        ...
        self.human = Human_Diagnostic(indicators_layout, 
                                        footIMU_topic="footIMU/IMU", 
                                        odometry_topic="imu_odometry",
                                        uwb_topic='/human/UWB', 
                                        odometry_service="/human_ros_launcher/odometry", 
                                        fusion_service="/human_ros_launcher/fusion",
                                        glove_service="/human_ros_launcher/glove",
                                        gun_service="/human_ros_launcher/gun",
                                        hri_service="/human_ros_launcher/hri",
                                        drone_yaw_control_service="/human_ros_launcher/drone_yaw_control",
                                        uwb_service="/human_ros_launcher/uwb")

        self.uav1 = UAV_Diagnostic(indicators_layout, 
                                        uwb_topic='/UAV1/UWB',
                                        odom_topic="/camera_1/odom/sample", 
                                        uav_name='UAV1', 
                                        uwb_service="/uav1_ros_launcher/uwb",
                                        datafeed_service="/uav1_ros_launcher/datafeed", 
                                        target_topic="/uav1/target_odom")

        self.uav2 = UAV_Diagnostic(indicators_layout, 
                                    uwb_topic='/UAV2/UWB',
                                    odom_topic="/camera_2/odom/sample", 
                                    uav_name='UAV2', 
                                    uwb_service="/uav2_ros_launcher/uwb", 
                                    datafeed_service="/uav2_ros_launcher/datafeed",
                                    target_topic="/uav2/target_odom")
