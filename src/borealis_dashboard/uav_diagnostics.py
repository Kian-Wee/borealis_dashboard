...
from local_position_visualizer_posewithcovariancestamped import PositionVisualizerStamped
...
class UAV_Diagnostic(QObject):
    ...
    def __init__(self, layout, uwb_topic, odom_topic, uav_name, uwb_service, 
                    ...
                    teaming_planner_rf_phasesync_topic, teaming_planner_cp_status_topic, ping_server):
        ...
        self.teaming_planner_rf_phasesync_topic = teaming_planner_rf_phasesync_topic 
        self.teaming_planner_cp_status_topic= teaming_planner_cp_status_topic
    ...
    def createInterface(self):
        ...
        self.uav_status_layout = UAVStatusVisualizer(self.uav_state_status_topic, self.uav_battery_status_topic, self.uav_mode_topic,self.planner_status_topic, 
        self.teaming_planner_rf_phasesync_topic, self.teaming_planner_cp_status_topic, self.ping_server, "UAV Status")
